<div>
    ...
    <nav class="pt-3 pb-0 bg-purple-200">
        ...
        <div class="lg:visible">
        <a href="#" wire:click="$set('section','women')" class="font-normal rounded bg-grey-400 hover:underline">Women</a>
        </div>
           <div class="lg:visible">
        <a href="#" wire:click="$set('section','men')" class="font-normal rounded bg-grey-400 hover:underline">Men</a>
        </div>
            <div class="lg:visible">
        <a href="#" wire:click="$set('section', 'company')" class="font-normal rounded bg-grey-400 hover:underline">Company</a>
        </div>
        <div class="lg:visible">
        <a href="#" wire:click="$set('section', 'quote')" class="font-normal rounded bg-grey-400 hover:underline">Get kanye Quote</a>
            </div>
        </div>
    ...
    style="background-image: url('https://cdn.pixabay.com/photo/2014/12/16/22/25/sunset-570881__340.jpg');">
...
@if ($section == 'company')
    ...
    style="background-image: url('https://cdn.pixabay.com/photo/2017/05/04/16/37/meeting-2284501__340.jpg');">

    <div class="flex items-center"></div>
    <p class="p-1 text-center break-normal align-middle rounded bg-grey-400">Company</p>
...
<button wire:click="$toggle('showQuote')" class="px-4 py-2 font-semibold text-blue-700 bg-white border border-blue-500 rounded hover:bg-white-500 hover:text-blue hover:border-transparent">Get Quote</button>
@if ($showQuote)
<livewire:kanye-api/>
@endif
</div>
